...
exports.createTokenWithPersoneId = exports.createToken = void 0;
...
function createTokenWithPersoneId(user, personeIdentity) {
    const payload = {
        user_id: user.user_id,
        user_name: user.user_name,
        user_lastname: user.user_lastname,
...
exports.createTokenWithPersoneId = createTokenWithPersoneId;
